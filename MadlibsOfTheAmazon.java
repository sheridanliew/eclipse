...
JOptionPane.showMessageDialog(null, "Piranhas are more "+adjective+" during "
		+ "the day, \n so cross the river at night. Piranhas \n are attracted to fresh "
		+ ""+liquid+" and will \n most likely take a bite out of your \n "+body+" if "
		+ "you "+verb+". Whatever you do, if \n you have an open wound, try to \n find "
